...
LAST_TABLE = 'shop_last_inventory_test'
SKU_TABLE = 'shop_sku_inventory_test'
...
KAFKA_PROD_FOOTTOPIC = 'compute'
KAFKA_GROUP_ID = 'FootPressureTest1'
...
# logFilePath = '/home/ec2-user/zhanghao/log/dataetl/modelcompute_v1.0'
logFilePath = 'D:\\recommend\pressuretest\log\modelcompute_v1.0'
